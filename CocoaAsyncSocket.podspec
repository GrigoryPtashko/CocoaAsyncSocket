...
Updated and maintained by Deusty LLC and the Apple development community.
  ...
  s.homepage = 'https://github.com/GrigoryPtashko/CocoaAsyncSocket'
  s.authors  = 'Dustin Voss', { 'Robbie Hanson' => 'robbiehanson@deusty.com' }

  s.source   = { :git => 'https://github.com/GrigoryPtashko/CocoaAsyncSocket.git',
                 :tag => "#{s.version}" }
  ...
  s.source_files = [
    'Source/GCD/*.{h,m}',
    'Source/Vendor/CocoaLumberjack/**/*.{h,m}'
  ]
